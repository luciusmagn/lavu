...
use reedline::{
    DefaultHinter, Highlighter, Hinter, History, Prompt, PromptEditMode, PromptViMode, Reedline,
    SqliteBackedHistory, StyledText, ValidationResult, Validator,
};
    ...
    impl Prompt for SchemePrompt {
        ...
        fn render_prompt_indicator(
            ...
            match prompt_mode {
                ...
                PromptEditMode::Vi(PromptViMode::Normal) => Cow::Borrowed("[N] λ "),
