    ...
    let mut primitives = vec![
        ...
        Primitive::new(
            ...
            Type::optional_procedure(
                vec![Type::String],
                vec![Type::Number],
                Type::union(vec![Type::Number, Type::False]),
            ),
        ),
        ...
        Primitive::new(
            "char=?",
            Type::procedure(vec![Type::Char, Type::Char], Type::Boolean),
        ),
        Primitive::new(
            "char<?",
            Type::procedure(vec![Type::Char, Type::Char], Type::Boolean),
        ...
        Primitive::new(
            "string=?",
            Type::procedure(vec![Type::String, Type::String], Type::Boolean),
        ),
        Primitive::new(
            "string<?",
            Type::procedure(vec![Type::String, Type::String], Type::Boolean),
        ...
        Primitive::new(
            ...
            Type::procedure(
                ...
                Type::union(vec![Type::False, Type::ListOf(Box::new(a.clone()))]),
            ),
        ),
        Primitive::new(
            "memv",
        ...
        Primitive::new(
            ...
            Type::procedure(
                ...
                Type::union(vec![Type::False, association_entry.clone()]),
            ),
        ),
        Primitive::new(
            "assv",
...
mod tests {
    ...
    #[test]
    fn exposes_numeric_and_character_primitives() {
        assert_eq!(
    ...
    fn exposes_membership_primitives() {
        assert_eq!(
            ...
            "(-> any? (listof a) (U #f (listof a)))"
        );
        assert_eq!(
            primitive("assoc").unwrap().signature.to_string(),
            "(-> any? (listof (pair? any? a)) (U #f (pair? any? a)))"
        );
    }
