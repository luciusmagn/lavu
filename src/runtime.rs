...
mod tests {
    ...
    fn treats_numeric_tower_literals_as_numbers() {
        ...
        assert_eq!(eval_one("#e1.5+2.25i"), "3/2+9/4i");
        assert_eq!(eval_one("#e.5+1e2i"), "1/2+100i");
        assert_eq!(eval_one("#b101+10i"), "5+2i");
        ...
        assert_eq!(eval_one("#d1+2i"), "1+2i");
        assert_eq!(eval_one("#d1.5+2.25i"), "1.5+2.25i");
        assert_eq!(eval_one("#e#d1.5+2.25i"), "3/2+9/4i");
        assert_eq!(eval_one("#i#d1/2+3/4i"), "0.5+0.75i");
        assert_eq!(eval_one("(exact? #i1+2i)"), "#f");
        assert_eq!(eval_one(".5+.5i"), "0.5+0.5i");
        assert_eq!(eval_one("1@0"), "1+0i");
        assert_eq!(eval_one("#d3@0"), "3+0i");
        assert_eq!(eval_one("#i#d1/2@0"), "0.5+0i");
    }
    ...
    fn evaluates_do_loops() {
        ...
        assert_eq!(eval_one("(do ((i 0 (+ i 1))) ((= i 1)))"), "#<unspecified>");
    }
    ...
    fn evaluates_if_with_scheme_truthiness() {
        ...
        assert_eq!(eval_one("(if #f 1)"), "#<unspecified>");
        assert_eq!(eval_one("(if #F 1 2)"), "2");
    ...
    fn evaluates_conversion_primitives() {
        ...
        assert_eq!(eval_one("(string->number \"#d1+2i\")"), "1+2i");
        assert_eq!(eval_one("(string->number \"#d1.5+2.25i\")"), "1.5+2.25i");
        assert_eq!(eval_one("(string->number \"#e#d1.5+2.25i\")"), "3/2+9/4i");
        assert_eq!(eval_one("(string->number \"#i#d1/2+3/4i\")"), "0.5+0.75i");
        ...
        assert_eq!(eval_one("(string->number \"-101-10i\" 2)"), "-5-2i");
        assert_eq!(
            eval_one("(string->number \"#e101/10+1/10i\" 2)"),
            "5/2+1/2i"
        );
        ...
        assert_eq!(eval_one("(string->number \"#d3@0\")"), "3+0i");
        assert_eq!(eval_one("(string->number \"#i#d1/2@0\")"), "0.5+0i");
